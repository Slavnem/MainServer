...
class LanguageSupport {
    public static function GetBasicLanguage($LANGUAGEID = NULL, $SUBLANGUAGEID = NULL, $KEYID = NULL): void {
        switch(NULL) {
            case $LANGUAGEID:
                echo json_encode(NULL);
                break;
            case $SUBLANGUAGEID:
                echo json_encode(LanguageData::$LANGUAGESDATA[$LANGUAGEID]);
                break;
            case $KEYID:
                echo json_encode(LanguageData::$LANGUAGESDATA[$LANGUAGEID][$SUBLANGUAGEID]);
                break;
            default:
                echo json_encode(LanguageData::$LANGUAGESDATA[$LANGUAGEID][$SUBLANGUAGEID][$KEYID]);
                break;
        }
    ...
    public static function GetDetailedLanguage($LANGUAGEID = NULL, $SUBLANGUAGEID = NULL, $KEYID = NULL): void {
